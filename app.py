...
st.title("Resume Classifying Application")
st.subheader("Efficiently Classify Resumes with Machine Learning")

uploaded_files = st.file_uploader(
    "Choose PDF files", type="pdf", accept_multiple_files=True)
output_directory = st.text_input("Output Directory", "classified_resumes")
